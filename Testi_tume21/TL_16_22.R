...
esko_lukutaito = esko_lukutaito %>%
  ...
  mutate(
    ...
    Q5_AnsC_lt = ifelse(PreOrd == 5 & AnsC == 1, 1, 0),
    Q6_AnsC_lt = ifelse(PreOrd == 6 & AnsC == 1, 1, 0),
    Q7_AnsC_lt = ifelse(PreOrd == 7 & AnsC == 1, 1, 0),
    Q8_AnsC_lt = ifelse(PreOrd == 8 & AnsC == 1, 1, 0),
    Q9_AnsC_lt = ifelse(PreOrd == 9 & AnsC == 1, 1, 0),
    Q10_AnsC_lt = ifelse(PreOrd == 10 & AnsC == 1, 1, 0),
    Q1_att_lt = ifelse(PreOrd == 1,1,0),
    Q2_att_lt = ifelse(PreOrd == 2,1,0),
    Q3_att_lt = ifelse(PreOrd == 3,1,0),
    Q4_att_lt = ifelse(PreOrd == 4,1,0),
    Q5_att_lt = ifelse(PreOrd == 5,1,0),
    Q6_att_lt = ifelse(PreOrd == 6,1,0),
    Q7_att_lt = ifelse(PreOrd == 7,1,0),
    Q8_att_lt = ifelse(PreOrd == 8,1,0),
    Q9_att_lt = ifelse(PreOrd == 9,1,0),
    Q10_att_lt = ifelse(PreOrd == 10,1,0)) %>%
  summarise(
